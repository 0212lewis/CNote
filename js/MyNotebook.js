...
var vue = new Vue({
    ...
    methods:{
        ...
        deleteConfirm:function () {
            ...
            alert(this.deleteCreateTime);
            alert(this.deleteTime);
            this.$http.get("http://localhost/CNote/php/MyNotebook.php",{
                params:{
                    act:'deleteNotebook',
                    username:this.username,
                    deleteNotebookName:this.deleteNotebookName,
                    createTime:this.deleteCreateTime,
        ...
        deleteRemind:function (name,createTime) {
            deleteRemindShow();
            this.deleteNotebookName = name;
            this.deleteCreateTime = createTime;
        },

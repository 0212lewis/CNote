        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function (a) {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [],
                             d = 0; d < c.length; d++)if (f)for (var e = 0; e < f.length; e++)b.push([a, c[d], f[e]].join("-")); else b.push([a, c[d]].join("-"));
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            ...
            if (h && m.type == CKEDITOR.NODE_TEXT && p.equals(m)) p = a.document.createText(p.substring(C, r)), c.append(p); else {
                ...
                for (var v = p.getParents(), D = m.getParents(), I = g(), E = v.length - 1, L = D.length - 1, J = c, ba,
                         Z, V, fa = -1, O = I; O <= E; O++) {
                    Z =
                        v[O];
                    V = Z.getNext();
                        ...
                        for (h = c(h); h || p;) {
                            ...
                            for (; p;)if (r = !1, p.type == CKEDITOR.NODE_COMMENT) p = p.getPrevious(); else {
                                if (p.type == CKEDITOR.NODE_TEXT) G = p.getText(), d.test(G) && (p = null), r = /[\s\ufeff]$/.test(G); else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark"))if (C && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                    G = p.getText();
                                    if (d.test(G)) p = null; else for (var H = p.$.getElementsByTagName("*"), w = 0,
                                                                           n; n =
        ...
        function h(a, b, c) {
            ...
            if (H.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(t()) : (a.parent && c.push({
                ...
                if (h) a.name = b, a.attributes =
                    ...
                    h = a.parent;
                    for (var p = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == h.name, r, g,
                             e = d.length; 0 < e;)m = d[--e], p && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && H.$inline[m.name]) ? (r || (r = new CKEDITOR.htmlParser.element(b), r.insertAfter(a), c.push({
                        check: "parent-down",
                        el: r
            ...
            var g = {}, l = function (b) {
                a.call(this, b, function (a) {
                    ...
                    for (f in a) {
                        ...
                        if (!d[f]) {
                            if (k.icons)for (var u = k.icons.split(","),
                                                 B = u.length; B--;)CKEDITOR.skin.addIcon(u[B], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + u[B] + ".png");
                            d[f] = 1
                        }
    ...
    (function () {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                for (var d = 0, g = this.rules, l = g.length,
                         k; c && d < l; d++)k = g[d], a.nonEditable && !k.options.applyToAll || a.nestedEditable && k.options.excludeNestedEditable || (c = c.replace(k.value[0], k.value[1]));
                return c
            }
        }
    })();
        ...
        var f = CKEDITOR.dom.walker.whitespaces(!0), x = CKEDITOR.dom.walker.bookmark(!1, !0),
            ...
            q = function () {
                ...
                function b(c, d) {
                    ...
                    e = d.range.startPath();
                    for (var l = q[l.getName()], r = 0, k = c.getChildren(), C = k.count(), G = -1, n = -1, w = 0,
                             K = e.contains(q.$list); r <
                                ...
                                if (t) D = 0 < I; else {
                                    ...
                                    if (E && J.isElement) {
                                        ...
                                        if (t) F && (W = x.splitElement(F),
                                            ...
                                            t = I == v.length - 1;
                                            F = d(J.node, F);
                                            for (var S = [], aa = F.length, ca = 0, ea = void 0, Y = 0,
                                                     U = -1; ca < aa; ca++)ea = F[ca], " " == ea ? (Y || X && !ca || (S.push(new CKEDITOR.dom.text(" ")), U = S.length), Y = 1) : (S.push(ea), Y = 0);
                                            t && U == S.length && S.pop();
                                            X = S
                                        }
                                    }
            ...
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    if (c.startContainer.isReadOnly())for (var d = c.startContainer,
                                                               e; d && !((e = d.type == CKEDITOR.NODE_ELEMENT) && d.is("body") || !d.isReadOnly());)e && "false" ==
            ...
            getNative: function () {
                ...
                var a = q ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), l = 0, v = e.length - 1, k = -1, m,
                                 E; l <= v;)if (k = Math.floor((l + v) / 2), f = e[k], h.moveToElementText(f), m = h.compareEndPoints("StartToStart", b), 0 < m) v = k - 1; else if (0 > m) l = k + 1; else return {
                            container: d,
                            offset: a(f)
                        };
    ...
    (function () {
            ...
            if (c.collapsed) f = F(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                for (r.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(w)) r = null, k = !0; else {
                        ...
                        if (x && m && CKEDITOR.dtd.$block[t])for (var A = r, z = e(A), C = void 0, G = z.length, H = 0,
                                                                      A = G && new CKEDITOR.dom.range(A.getDocument()); H < G; ++H) {
                    ...
                    if (k && u && !u.collapsed) {
                        for (var k = F(this, f), x = k.hasAttributes(), y = u.getCommonAncestor(), t = {}, z = {},
                                 C = {}, G = {}, U, P, da; k && y;) {
                            if (y.getName() == g) {
        ...
        function B(a) {
            for (var b = h(this), c = a.getElementsByTag(this.element), d,
                     e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || u.call(this, d, !0);
    ...
    (function () {
        function q(a, d) {
            ...
            a.on("selectionChange", function () {
                for (var c = [], e = k.list = [], g = [], b = k.filters, d = !0, l = a.elementPath().elements, f,
                         u = l.length; u--;) {
                    var h = l[u], r = 0;
